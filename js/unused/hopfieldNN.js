(function() {
  ...
  function HopfieldNet(nodeCount) {
    ...
    console.log("hopfield initialized");
  }

  HopfieldNet.prototype.test = function (samples , i, j) {
  ...
  window.HopfieldNet = HopfieldNet;
